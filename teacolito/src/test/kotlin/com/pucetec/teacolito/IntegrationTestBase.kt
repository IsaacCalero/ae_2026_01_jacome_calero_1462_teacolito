package com.pucetec.teacolito

import com.fasterxml.jackson.databind.ObjectMapper
import com.pucetec.teacolito.config.TestJwtDecoderConfig
...
abstract class IntegrationTestBase {
    ...
    // Not an injected Spring bean on purpose — see RequestLoggingFilter for why: this
    // Spring Boot 4 setup doesn't expose a default ObjectMapper bean in this context, and
    // these tests only need plain (de)serialization of request/response DTOs.
